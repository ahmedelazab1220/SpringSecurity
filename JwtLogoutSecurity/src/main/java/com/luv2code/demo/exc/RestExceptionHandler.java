...
public class RestExceptionHandler {
	...
	public ErrorResponse handleHttpMessageNotReadableException(HttpMessageNotReadableException ex, WebRequest request) {
		return new ErrorResponse(StatusCode.INVALID_ARGUMENT, "Invalid request body. Please provide valid data",
				"HttpMessageNotReadableException", ex.getMessage(), request.getDescription(false).substring(4),
				System.currentTimeMillis());
	}
